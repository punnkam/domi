"""
Provides chatbot and question-answering functionality over API
...
def create_chatbot_langchain(vectorstore, weaviate_url):
    import weaviate
    ...
    template = f"""You are an AI assistant for a landlord named {USER_SETTINGS.user_name}. 
