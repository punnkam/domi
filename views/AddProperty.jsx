                ...
                <View style={styles.buttonContainer}>
                  ...
                  >
                    <Text
                      style={[
                        styles.buttonText,
                        type === "Apartment" && styles.activeButtonText,
                      ]}
                    >
                      Apartment
                    </Text>
              ...
              <View style={styles.formGroup}>
                ...
                {tenants.map((tenant, index) => (
                  <View
                    ...
                    key={`${tenant.toString()}_${index}`}
                  >
                    <TextInput
                      style={styles.emailInput}
                      value={tenant}
                      placeholder="Enter tenant email"
                      onChangeText={(text) => handleTenantChange(text, index)}
                    />
                    {index !== 0 && (
                      <TouchableOpacity
                        ...
                        key={index}
                      >
                        <Text key={index} style={styles.removeButtonText}>
                          x
                        </Text>
                      </TouchableOpacity>
                    )}
